...
summary: ' پیاده‌سازی کمپین‌های ریفرال در یک کسب و کار نیاز به اجرای راهکارهای موثری دارد تا به کمک آن کاربران بیشتری جذب سرویس شوند.'
...
##  چه راهکارهای موثری برای راه‌اندازی برنامه‌های ریفرال (referral program) وجود دارد؟ 
...
###  تقویت نرخ بازگشت سرمایه (Rol-rate) 
...
### استفاده از امکان پوش نوتیفیکیشن (push notification) 
...
{{< extraBox title="چطور می‌توان کاربران را متقاعد کرد تا با سرویس تعامل برقرار کنند؟" description="اگر از پوش نوتیفیکیشن در زمان مناسب و با توجه به نیاز کاربران، استفاده نکنید؛ می‌تواند به پیامی اسپم تبدیل شود و کاربران را وادار به حذف اپلیکیشن کند. " buttonTitle="بیشتر بخوانید" buttonAction="https://blog.chabok.io/different-types-of-push-notification/" image="http://uupload.ir/files/uj7b_push-notification.png" >}}

###  استفاده از کانال‌های توزیع کننده (رسانه‌های اجتماعی) 
...
###  کنترل کیفیت برنامه ریفرال (referral program)
