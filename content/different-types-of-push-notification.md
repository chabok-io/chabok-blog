...
img: different-types-of-push-notification.png
...
description: 'پوش نوتیفیکیشن‌ها می‌توانند در موقعیت های مختلف استفاده شوند. پوش های انبوه و تبلیغاتی، پوش های ترنزشکنال و پوش های سگمنت شده ۳ مدل از معروف ترین پوش نوتیفیکیشن‌ها هتسند.'
---
...
در این مقاله از [بلاگ چابک](https://blog.chabok.io/)، قصد داریم مدل‌های ارسال پوش نوتیفیکیشن را بر اساس نوع مخاطب و نوع پیام دسته بندی کنیم . هدف ما از ارائه این دسته‌بندی ارائه یک دید جامع از نحوه استفاده و کاربرد انواع گوناگون پوش نوتیفیکیشن است.
